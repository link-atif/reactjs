        ...
        .then(({ data: response }) => {
          ...
          if (
            ...
            data.output.forEach((item) => {
              codeAmounts.push({
                JCODE: item.JCODE,
                amount: Math.round(item.ChargeAmount)
              });
            });
            // setCodeNames(codenames);
            // setCodeAmount(codeAmounts);
            setRejectedJcode(codeAmounts);
          }
        })
        .catch((error) => {
          setCodeLoadingClass("");
  ...
  return (
    <>
      ...
      <div className="dashboard-main">
                ...
                <Grid item xs={12}>
                  <div className="pre-adj-tabs-all">
                    <ul>
                      <li>
                        <NavLink to="/">
                          <img src={Tabclaimsicon} alt="icon" />
                          <label>Claims</label>
                        </NavLink>
                      </li>
                      <li>
                      ...
                      <li>
                        <NavLink to="/denails" className="pre-active" >
        ...
        <div className="pre-adj-tabs-all mt-4  mb-0">
          <ul className=" mb-0">
            <li>
          ...
          <ul className="pull-right cb mb-0">
            <li>
              <NavLink to="/codes" >
                <img src={TabInsightsiconGr} alt="icon" />
                <label>Heatmap</label>
        ...
        >
          <Grid item sm={12}>
            <Box className="line-chart-outer-crd mt-2 ">
        ...
        <Grid container>
          <Grid item sm={12}>
            <Box className="line-chart-outer-crd line-f-hi mt-4">
              <div className="dash-btn-main">
