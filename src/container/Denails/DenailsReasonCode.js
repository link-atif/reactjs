...
const DenailsReasonCode = () => {
  ...
  const [payerStartDate, setPayerStartDate] = useState("2021-03-02");
  const [payerEndDate, setPayerEndDate] = useState("2021-04-02");
  ...
  }, [codeStartDate, codeEndDate, selectedReasonCode]);
  useEffect(() => {
    if (selectedCode !== "") {
      setStep(2);
      setNestedLoadingClass("data-loading");
      danialService
        .getDenialsReasonCodeCPTCodePayer(
          payerStartDate,
          payerEndDate,
          selectedReasonCode,
          selectedCode
  ...
  }, [payerStartDate, payerEndDate, selectedCode]);
  ...
  }, [claimStartDate, claimEndDate, selectedPayer]);
  const handleChange = (event, newValue) => {
    setValue(newValue);
  };
  const handleReasonCodeSelection = (e) => {
    setCodesList([]);
    setStep(0);
    setPayerList([]);
    setSelectedCode("");
  ...
  const handleDateFilter = (date) => {
    ...
    if (step === 0) {
      ...
      setPayerStartDate(startDate);
      setPayerEndDate(endDate);
    } else {
            ...
            >
              <Table aria-label="collapsible table">
                <TableHead>
                  <TableRow>
                    <TableCell>
                      <span className="mr-5"></span> Reason Code
                    </TableCell>
                                                            ...
                                                            return (
                                                              <React.Fragment>
                                                                <TableRow>
                                                                  ...
                                                                  <TableCell>
                                                                    {
                                                                      payerItem.NoOfDenied
                                                                    }
                                                                  </TableCell>
                                                                  <TableCell>
                                                                    {
                                                                      payerItem.ChargeAmount
                                                                    }
                                                                  </TableCell>
                                                                </TableRow>
                                                                <TableRow>
...
export default DenailsReasonCode;
